  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-secondary/20">
      ...
      <main className="max-w-5xl mx-auto px-6 py-20">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-4">Interactive Art Tool</h1>
          <p className="text-xl text-muted-foreground mb-8">
            A creative coding project exploring digital art generation and real-time rendering with Three.js
          </p>
          ...
          >
            <section>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                An interactive web application that generates procedural digital art in real-time. The project
                demonstrates advanced graphics programming concepts including WebGL shaders, particle systems, and
                algorithmic art generation. Users can interact with the canvas to create unique visual experiences.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                  { category: 'Graphics', tech: 'Three.js, WebGL, GLSL' },
                  { category: 'Frontend', tech: 'React, TypeScript, Canvas API' },
                  { category: 'Build Tools', tech: 'Vite, Webpack' },
                  { category: 'Libraries', tech: 'Perlin Noise, Math.js' },
                  { category: 'Performance', tech: 'RequestAnimationFrame' },
                  { category: 'Testing', tech: 'Jest, Vitest' },
                ].map((item) => (
                  <motion.div
                    key={item.category}
                    whileHover={{ y: -5 }}
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    description: 'Used Perlin noise and fractal algorithms to generate infinite variations of art',
                  },
                  {
                    title: 'Performance Optimization',
                    description: 'Optimized rendering pipeline using instancing and batch rendering techniques',
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
                  ...
                  >
                    <h3 className="font-semibold text-foreground mb-2 text-primary">{item.title}</h3>
