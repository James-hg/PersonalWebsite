...
export default function RolesSection() {
    const lifeguardRoles = [
        ...
        },
        {
            ...
            image: "/iat210/images/bodyguard.png",
        ...
        {
            name: "Doctor",
            image: "/iat210/images/doctor.png",
            description: "Protects one player each night",
            ability:
    ...
    const patronRoles = [
        {
            name: "Leader Patron",
            image: "/iat210/images/leader-patron.png",
                            ...
                            <CardHeader className="text-center p-6">
                                <div className="flex justify-center mb-3">
                                    <div className="w-48 h-72 relative rounded-lg overflow-hidden shadow-md">
                                        <Image
                                            src="/iat210/images/narrator.png" // Your generated image path
                                            alt="Narrator"
                                            fill
                        ...
                        <Card className="hover:shadow-lg transition-all border-2 border-blue-200 bg-white">
                            <CardHeader className="text-center p-6">
                                <div className="flex justify-center mb-3">
                                    <div className="w-48 h-72 relative rounded-lg overflow-hidden shadow-md">
                                        <Image
                                            src="/iat210/images/lifeguard.png"
                        ...
                        <Card className="hover:shadow-lg transition-all border-2 border-red-200 bg-white">
                            <CardHeader className="text-center p-6">
                                <div className="flex justify-center mb-3">
                                    <div className="w-48 h-72 relative rounded-lg overflow-hidden shadow-md">
                                        <Image
                                            src="/iat210/images/regular-patron.png"
                                            alt="Regular Patrons"
                                            fill
                                            className="object-cover"
                                        />
